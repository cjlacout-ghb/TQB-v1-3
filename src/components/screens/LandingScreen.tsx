    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 flex flex-col items-center justify-center min-h-[70vh] animate-fade-in text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl mt-8">
                ...
                {canContinue && (
                    <Tooltip text={t.tooltips.landingSingleGroup} className="w-full">
                        <button
                            onClick={onContinueTournament}
                            className="group flex flex-col items-center p-10 bg-dark-800 border border-dark-600 rounded-2xl hover:border-success-500/50 hover:bg-dark-700 transition-all duration-300 text-center w-full"
                        >
                ...
                {/* New Tournament Card */}
                <Tooltip text={t.tooltips.landingSingleGroup} className={`w-full ${!canContinue ? 'md:col-span-2 max-w-sm mx-auto' : ''}`}>
                    <button
                        onClick={onNewTournament}
                        className="group flex flex-col items-center p-10 bg-dark-800 border border-dark-600 rounded-2xl hover:border-primary-500/50 hover:bg-dark-700 transition-all duration-300 text-center w-full"
                    >
